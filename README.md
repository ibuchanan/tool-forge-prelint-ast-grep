...
package-scripts checks below: Forge Ahead errors everywhere, Forge Ahead API
types when `@forge/api` is present, Node version pin, tsconfig.json/
tsconfig.build.json drift from the Forge bundler baseline, biome.json and
lefthook.yml hook drift, vitest.config.ts globals, and package.json metadata
(private/license/main/types/exports, typescript major version) generated by
the template.
